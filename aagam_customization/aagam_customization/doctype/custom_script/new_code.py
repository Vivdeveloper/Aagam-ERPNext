...
# from frappe.utils.formatters import bold

# class CustomJobCard(OriginalJobCard):
# 	def __init__(self, *args, **kwargs):
# 		super(CustomJobCard, self).__init__(*args, **kwargs)
...
# def custom_patch(doc, method=None):
#     from erpnext.manufacturing.doctype.job_card import job_card
# job_card.JobCard.validate_job_card = custom_validate_job_card